        ...
        <div class="dashboard-content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('design.update', $item->id)}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="">Pemilik Design</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="">Kategori design</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="date">tanggal Desgin</label>
